# from https://github.com/qtweng/f1tenth-gym/
import numpy as np
import math
...
class GapFollower:
    ...
    def process_lidar(self, scan: LaserScan):
...
class DisparityExtenderMax:
    BUBBLE_RADIUS = 160
    PREPROCESS_CONV_SIZE = 3
    MAX_LIDAR_DIST = 3000000
    STRAIGHTS_SPEED = 8.0
    CORNERS_SPEED = 5.0
    STRAIGHTS_STEERING_ANGLE = math.radians(15)
    CAR_WIDTH = 0.31
    ...
    def process_lidar(self, scan: LaserScan):
        ...
        """
        ranges = scan.ranges
        self.radians_per_point = scan.angle_increment
        proc_ranges = self.preprocess_lidar(ranges)
        differences = self.get_differences(proc_ranges)
